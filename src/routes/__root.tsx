  ...
  head: () => ({
    meta: [
      ...
      { title: "Zebnex Tech Solutions | Technology & Branding in Kenya" },
      {
        name: "description",
        content:
          "Zebnex Tech Solutions builds secure networks, cloud systems, custom software, websites and brand identities for businesses across Kenya.",
      },
      { name: "author", content: "Zebnex Tech Solutions" },
